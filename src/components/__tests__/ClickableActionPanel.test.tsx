...
import { ClickableActionPanelTheme } from 'enums';
...
describe('ClickableActionPanel', () => {
  it('renders internal link as a router Link with theme class', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.CALENDAR} />);
  ...
  it('renders external link with target and rel attributes', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.INSTAGRAM} />);
  ...
  it('should return theme class ClickableActionPanelTheme.DEFAULT if option is SUBMIT_BIRTHDAY', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.SUBMIT_BIRTHDAY} />);
  ...
  it('should return theme class ClickableActionPanelTheme.DEFAULT if option is BEER', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.BEER} />);
  ...
  it('should return theme class ClickableActionPanelTheme.FACEBOOK if option is FACEBOOK', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.FACEBOOK} />);
  ...
  it('should return theme class ClickableActionPanelTheme.THREADS if option is THREADS', () => {
    new UnitTestUtils(<ClickableActionPanel option={ClickableActionPanelLink.THREADS} />);
